				...
				<div class="layui-card-body">
					...
					<form class="layui-form layui-form-pane" action="">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="username" lay-verify="required"
									placeholder="请输入资费名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="username" lay-verify="required"
									placeholder="请输入基本费用（单位RMB）" autocomplete="off"
									class="layui-input">
							</div>
							<label class="layui-form-label">单位费用</label>
							<div class="layui-input-inline">
								<input type="text" name="username" lay-verify="required"
									placeholder="请输入单位费用" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="username" lay-verify="required"
									placeholder="请输入基本时长" autocomplete="off" class="layui-input">
							</div>
						</div>
